...
- `텍스트 세션`: rewrite Korean drafts into polished scientific English inspired by Nature Reviews Drug Discovery and Nature Portfolio writing guidance, without keeping a writing history in the app session.
